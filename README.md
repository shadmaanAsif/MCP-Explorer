...
A hands-on project for learning **MCP (Model Context Protocol)** by building a real server one small, understandable step at a time — instead of reading about MCP, we build it.

> This README is also published as a browsable page: **[MCP Demo Roadmap](https://claude.ai/code/artifact/2ac1d88f-d347-40a2-ac23-1febc68554d0)**. It mirrors everything here — keep both in sync as the plan changes.
